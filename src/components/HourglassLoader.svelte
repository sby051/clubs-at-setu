...
<style>
	.hourglass {
		animation: hourglass 800ms ease-in-out infinite;
	}

	@keyframes hourglass {
		0% {
			transform: rotate(0deg);
			box-shadow: inset black 0 0em 0 0, inset white 0 -2em 0 0, inset black 0 -4em 0 0;
		}
		80% {
			transform: rotate(0deg);
			box-shadow: inset black 0 -2em 0 0, inset white 0 -2em 0 0, inset black 0 -2em 0 0;
		}
		100% {
